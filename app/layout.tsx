...
export const metadata: Metadata = {
  ...
  description:
    "Cybersecurity Engineer actively transitioning to Pentester/Red Team. AD security, IAM automation, AWS security design, HTB practice (73 machines), and OSCP preparation.",
  keywords: [
    "Cybersecurity",
    "IAM",
    "Blue Team",
